...
export default function IncomePage() {
  ...
  useEffect(() => {
    ...
    loadData();
  }, [searchParams]);  // Handlers para las acciones
  ...
  if (isLoading || !stats) {
    return (
      <PageContainer scrollable pageTitle="Ingresos" pageDescription="Rastrea y gestiona tus transacciones de ingreso">
  ...
  return (
    <PageContainer
      scrollable
      pageTitle="Ingresos"
      pageDescription="Rastrea y gestiona tus transacciones de ingreso"
      pageHeaderAction={
        <div className="flex gap-2">
          ...
          >
            <IconPlus className="mr-2 h-4 w-4" /> Nuevo Ingreso
          </Button>
        </div>
      }
    >
            ...
            <CardHeader>
              ...
              <CardTitle className='text-2xl font-semibold tabular-nums @[250px]/card:text-3xl'>
                {new Intl.NumberFormat('es-CO', {
                  ...
                  currency: 'COP',
                  minimumFractionDigits: 0
                }).format(stats.totalIngresos - completedAmount)}
              </CardTitle>
              <CardAction>
                <Badge variant='outline'>
